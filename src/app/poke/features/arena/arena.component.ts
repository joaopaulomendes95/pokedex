...
import { AutoBattleService } from '@poke/auto-battle.service';
import {
  CUPS,
  Cup,
  CUP_BATTLE_ENERGY,
...
import { CupRunService } from '@poke/cup-run.service';
import { AppDialogService, BasicViewComponent } from '@shared/ui';
...
export class ArenaComponent {
  ...
  constructor(
    public runner: MatchRunner,
    public game: GameService,
    public data: PokeDataService,
    public auto: AutoBattleService,
    private readonly notify: NotifyService,
    private readonly dialog: AppDialogService,
    readonly cupRuns: CupRunService,
  ) {}
