...
import { GameService, SAVE_KEY } from '@poke/game.service';
...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, MatCardModule, MatIconModule, BasicViewComponent],
...
export class UserComponent {
  ...
  public readonly genFilter = inject(GenerationFilterService);
