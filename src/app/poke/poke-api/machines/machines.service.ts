...
import type { MachineDetail, MachineListParams, PaginatedMachineSummaryList } from '@poke/poke-api/model';
 ...
 */
export function machineListResource(
  params: Signal<MachineListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedMachineSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedMachineSummaryList>;
  },
): HttpResourceRef<PaginatedMachineSummaryList>;
export function machineListResource(
  params?: Signal<MachineListParams>,
  options?: OrvalHttpResourceOptions<PaginatedMachineSummaryList, unknown>,
): HttpResourceRef<PaginatedMachineSummaryList | undefined>;
export function machineListResource(
  params?: Signal<MachineListParams>,
  options?: OrvalHttpResourceOptions<PaginatedMachineSummaryList, unknown>,
): HttpResourceRef<PaginatedMachineSummaryList | undefined> {
  return httpResource<PaginatedMachineSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function machineRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<MachineDetail, unknown> & {
    defaultValue: NoInfer<MachineDetail>;
  },
): HttpResourceRef<MachineDetail>;
export function machineRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<MachineDetail, unknown>,
): HttpResourceRef<MachineDetail | undefined>;
export function machineRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<MachineDetail, unknown>,
): HttpResourceRef<MachineDetail | undefined> {
  return httpResource<MachineDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/machine/${id()}/`, options),
    options,
  );
}

export type MachineListResourceResult = NonNullable<PaginatedMachineSummaryList>;
export type MachineRetrieveResourceResult = NonNullable<MachineDetail>;
