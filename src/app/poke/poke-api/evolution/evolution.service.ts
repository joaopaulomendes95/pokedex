 ...
 */
export function evolutionChainListResource(
  params: Signal<EvolutionChainListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedEvolutionChainSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedEvolutionChainSummaryList>;
  },
): HttpResourceRef<PaginatedEvolutionChainSummaryList>;
export function evolutionChainListResource(
  params?: Signal<EvolutionChainListParams>,
  options?: OrvalHttpResourceOptions<PaginatedEvolutionChainSummaryList, unknown>,
): HttpResourceRef<PaginatedEvolutionChainSummaryList | undefined>;
export function evolutionChainListResource(
  params?: Signal<EvolutionChainListParams>,
  options?: OrvalHttpResourceOptions<PaginatedEvolutionChainSummaryList, unknown>,
): HttpResourceRef<PaginatedEvolutionChainSummaryList | undefined> {
  return httpResource<PaginatedEvolutionChainSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function evolutionChainRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<EvolutionChainDetail, unknown> & {
    defaultValue: NoInfer<EvolutionChainDetail>;
  },
): HttpResourceRef<EvolutionChainDetail>;
export function evolutionChainRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<EvolutionChainDetail, unknown>,
): HttpResourceRef<EvolutionChainDetail | undefined>;
export function evolutionChainRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<EvolutionChainDetail, unknown>,
): HttpResourceRef<EvolutionChainDetail | undefined> {
  return httpResource<EvolutionChainDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/evolution-chain/${id()}/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function evolutionTriggerListResource(
  params: Signal<EvolutionTriggerListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedEvolutionTriggerSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedEvolutionTriggerSummaryList>;
  },
): HttpResourceRef<PaginatedEvolutionTriggerSummaryList>;
export function evolutionTriggerListResource(
  params?: Signal<EvolutionTriggerListParams>,
  options?: OrvalHttpResourceOptions<PaginatedEvolutionTriggerSummaryList, unknown>,
): HttpResourceRef<PaginatedEvolutionTriggerSummaryList | undefined>;
export function evolutionTriggerListResource(
  params?: Signal<EvolutionTriggerListParams>,
  options?: OrvalHttpResourceOptions<PaginatedEvolutionTriggerSummaryList, unknown>,
): HttpResourceRef<PaginatedEvolutionTriggerSummaryList | undefined> {
  return httpResource<PaginatedEvolutionTriggerSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function evolutionTriggerRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<EvolutionTriggerDetail, unknown> & {
    defaultValue: NoInfer<EvolutionTriggerDetail>;
  },
): HttpResourceRef<EvolutionTriggerDetail>;
export function evolutionTriggerRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<EvolutionTriggerDetail, unknown>,
): HttpResourceRef<EvolutionTriggerDetail | undefined>;
export function evolutionTriggerRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<EvolutionTriggerDetail, unknown>,
): HttpResourceRef<EvolutionTriggerDetail | undefined> {
  return httpResource<EvolutionTriggerDetail>(
    () =>
      applyOrvalRequestExtension(`https://pokeapi.co/api/v2/evolution-trigger/${id()}/`, options),
    options,
  );
}

export type EvolutionChainListResourceResult = NonNullable<PaginatedEvolutionChainSummaryList>;
export type EvolutionChainRetrieveResourceResult = NonNullable<EvolutionChainDetail>;
export type EvolutionTriggerListResourceResult = NonNullable<PaginatedEvolutionTriggerSummaryList>;
export type EvolutionTriggerRetrieveResourceResult = NonNullable<EvolutionTriggerDetail>;
