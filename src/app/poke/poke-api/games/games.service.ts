 ...
 */
export function generationListResource(
  params: Signal<GenerationListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedGenerationSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedGenerationSummaryList>;
  },
): HttpResourceRef<PaginatedGenerationSummaryList>;
export function generationListResource(
  params?: Signal<GenerationListParams>,
  options?: OrvalHttpResourceOptions<PaginatedGenerationSummaryList, unknown>,
): HttpResourceRef<PaginatedGenerationSummaryList | undefined>;
export function generationListResource(
  params?: Signal<GenerationListParams>,
  options?: OrvalHttpResourceOptions<PaginatedGenerationSummaryList, unknown>,
): HttpResourceRef<PaginatedGenerationSummaryList | undefined> {
  return httpResource<PaginatedGenerationSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function generationRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<GenerationDetail, unknown> & {
    defaultValue: NoInfer<GenerationDetail>;
  },
): HttpResourceRef<GenerationDetail>;
export function generationRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<GenerationDetail, unknown>,
): HttpResourceRef<GenerationDetail | undefined>;
export function generationRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<GenerationDetail, unknown>,
): HttpResourceRef<GenerationDetail | undefined> {
  return httpResource<GenerationDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/generation/${id()}/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function pokedexListResource(
  params: Signal<PokedexListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedPokedexSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedPokedexSummaryList>;
  },
): HttpResourceRef<PaginatedPokedexSummaryList>;
export function pokedexListResource(
  params?: Signal<PokedexListParams>,
  options?: OrvalHttpResourceOptions<PaginatedPokedexSummaryList, unknown>,
): HttpResourceRef<PaginatedPokedexSummaryList | undefined>;
export function pokedexListResource(
  params?: Signal<PokedexListParams>,
  options?: OrvalHttpResourceOptions<PaginatedPokedexSummaryList, unknown>,
): HttpResourceRef<PaginatedPokedexSummaryList | undefined> {
  return httpResource<PaginatedPokedexSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function pokedexRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<PokedexDetail, unknown> & {
    defaultValue: NoInfer<PokedexDetail>;
  },
): HttpResourceRef<PokedexDetail>;
export function pokedexRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<PokedexDetail, unknown>,
): HttpResourceRef<PokedexDetail | undefined>;
export function pokedexRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<PokedexDetail, unknown>,
): HttpResourceRef<PokedexDetail | undefined> {
  return httpResource<PokedexDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/pokedex/${id()}/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function versionListResource(
  params: Signal<VersionListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedVersionSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedVersionSummaryList>;
  },
): HttpResourceRef<PaginatedVersionSummaryList>;
export function versionListResource(
  params?: Signal<VersionListParams>,
  options?: OrvalHttpResourceOptions<PaginatedVersionSummaryList, unknown>,
): HttpResourceRef<PaginatedVersionSummaryList | undefined>;
export function versionListResource(
  params?: Signal<VersionListParams>,
  options?: OrvalHttpResourceOptions<PaginatedVersionSummaryList, unknown>,
): HttpResourceRef<PaginatedVersionSummaryList | undefined> {
  return httpResource<PaginatedVersionSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function versionRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<VersionDetail, unknown> & {
    defaultValue: NoInfer<VersionDetail>;
  },
): HttpResourceRef<VersionDetail>;
export function versionRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<VersionDetail, unknown>,
): HttpResourceRef<VersionDetail | undefined>;
export function versionRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<VersionDetail, unknown>,
): HttpResourceRef<VersionDetail | undefined> {
  return httpResource<VersionDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/version/${id()}/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function versionGroupListResource(
  params: Signal<VersionGroupListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedVersionGroupSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedVersionGroupSummaryList>;
  },
): HttpResourceRef<PaginatedVersionGroupSummaryList>;
export function versionGroupListResource(
  params?: Signal<VersionGroupListParams>,
  options?: OrvalHttpResourceOptions<PaginatedVersionGroupSummaryList, unknown>,
): HttpResourceRef<PaginatedVersionGroupSummaryList | undefined>;
export function versionGroupListResource(
  params?: Signal<VersionGroupListParams>,
  options?: OrvalHttpResourceOptions<PaginatedVersionGroupSummaryList, unknown>,
): HttpResourceRef<PaginatedVersionGroupSummaryList | undefined> {
  return httpResource<PaginatedVersionGroupSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function versionGroupRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<VersionGroupDetail, unknown> & {
    defaultValue: NoInfer<VersionGroupDetail>;
  },
): HttpResourceRef<VersionGroupDetail>;
export function versionGroupRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<VersionGroupDetail, unknown>,
): HttpResourceRef<VersionGroupDetail | undefined>;
export function versionGroupRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<VersionGroupDetail, unknown>,
): HttpResourceRef<VersionGroupDetail | undefined> {
  return httpResource<VersionGroupDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/version-group/${id()}/`, options),
    options,
  );
}

export type GenerationListResourceResult = NonNullable<PaginatedGenerationSummaryList>;
export type GenerationRetrieveResourceResult = NonNullable<GenerationDetail>;
export type PokedexListResourceResult = NonNullable<PaginatedPokedexSummaryList>;
export type PokedexRetrieveResourceResult = NonNullable<PokedexDetail>;
export type VersionListResourceResult = NonNullable<PaginatedVersionSummaryList>;
export type VersionRetrieveResourceResult = NonNullable<VersionDetail>;
export type VersionGroupListResourceResult = NonNullable<PaginatedVersionGroupSummaryList>;
export type VersionGroupRetrieveResourceResult = NonNullable<VersionGroupDetail>;
