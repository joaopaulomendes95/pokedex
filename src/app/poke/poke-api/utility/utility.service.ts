 ...
 */
export function metaRetrieveResource(
  options: OrvalHttpResourceOptions<MetaRetrieve200, unknown> & {
    defaultValue: NoInfer<MetaRetrieve200>;
  },
): HttpResourceRef<MetaRetrieve200>;
export function metaRetrieveResource(
  options?: OrvalHttpResourceOptions<MetaRetrieve200, unknown>,
): HttpResourceRef<MetaRetrieve200 | undefined>;
export function metaRetrieveResource(
  options?: OrvalHttpResourceOptions<MetaRetrieve200, unknown>,
): HttpResourceRef<MetaRetrieve200 | undefined> {
  return httpResource<MetaRetrieve200>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/meta/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function languageListResource(
  params: Signal<LanguageListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedLanguageSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedLanguageSummaryList>;
  },
): HttpResourceRef<PaginatedLanguageSummaryList>;
export function languageListResource(
  params?: Signal<LanguageListParams>,
  options?: OrvalHttpResourceOptions<PaginatedLanguageSummaryList, unknown>,
): HttpResourceRef<PaginatedLanguageSummaryList | undefined>;
export function languageListResource(
  params?: Signal<LanguageListParams>,
  options?: OrvalHttpResourceOptions<PaginatedLanguageSummaryList, unknown>,
): HttpResourceRef<PaginatedLanguageSummaryList | undefined> {
  return httpResource<PaginatedLanguageSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function languageRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<LanguageDetail, unknown> & {
    defaultValue: NoInfer<LanguageDetail>;
  },
): HttpResourceRef<LanguageDetail>;
export function languageRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<LanguageDetail, unknown>,
): HttpResourceRef<LanguageDetail | undefined>;
export function languageRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<LanguageDetail, unknown>,
): HttpResourceRef<LanguageDetail | undefined> {
  return httpResource<LanguageDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/language/${id()}/`, options),
    options,
  );
}

export type MetaRetrieveResourceResult = NonNullable<MetaRetrieve200>;
export type LanguageListResourceResult = NonNullable<PaginatedLanguageSummaryList>;
export type LanguageRetrieveResourceResult = NonNullable<LanguageDetail>;
