 ...
 */
export function contestTypeListResource(
  params: Signal<ContestTypeListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedContestTypeSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedContestTypeSummaryList>;
  },
): HttpResourceRef<PaginatedContestTypeSummaryList>;
export function contestTypeListResource(
  params?: Signal<ContestTypeListParams>,
  options?: OrvalHttpResourceOptions<PaginatedContestTypeSummaryList, unknown>,
): HttpResourceRef<PaginatedContestTypeSummaryList | undefined>;
export function contestTypeListResource(
  params?: Signal<ContestTypeListParams>,
  options?: OrvalHttpResourceOptions<PaginatedContestTypeSummaryList, unknown>,
): HttpResourceRef<PaginatedContestTypeSummaryList | undefined> {
  return httpResource<PaginatedContestTypeSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function contestTypeRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<ContestTypeDetail, unknown> & {
    defaultValue: NoInfer<ContestTypeDetail>;
  },
): HttpResourceRef<ContestTypeDetail>;
export function contestTypeRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<ContestTypeDetail, unknown>,
): HttpResourceRef<ContestTypeDetail | undefined>;
export function contestTypeRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<ContestTypeDetail, unknown>,
): HttpResourceRef<ContestTypeDetail | undefined> {
  return httpResource<ContestTypeDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/contest-type/${id()}/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function contestEffectListResource(
  params: Signal<ContestEffectListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedContestEffectSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedContestEffectSummaryList>;
  },
): HttpResourceRef<PaginatedContestEffectSummaryList>;
export function contestEffectListResource(
  params?: Signal<ContestEffectListParams>,
  options?: OrvalHttpResourceOptions<PaginatedContestEffectSummaryList, unknown>,
): HttpResourceRef<PaginatedContestEffectSummaryList | undefined>;
export function contestEffectListResource(
  params?: Signal<ContestEffectListParams>,
  options?: OrvalHttpResourceOptions<PaginatedContestEffectSummaryList, unknown>,
): HttpResourceRef<PaginatedContestEffectSummaryList | undefined> {
  return httpResource<PaginatedContestEffectSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function contestEffectRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<ContestEffectDetail, unknown> & {
    defaultValue: NoInfer<ContestEffectDetail>;
  },
): HttpResourceRef<ContestEffectDetail>;
export function contestEffectRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<ContestEffectDetail, unknown>,
): HttpResourceRef<ContestEffectDetail | undefined>;
export function contestEffectRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<ContestEffectDetail, unknown>,
): HttpResourceRef<ContestEffectDetail | undefined> {
  return httpResource<ContestEffectDetail>(
    () => applyOrvalRequestExtension(`https://pokeapi.co/api/v2/contest-effect/${id()}/`, options),
    options,
  );
}
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function superContestEffectListResource(
  params: Signal<SuperContestEffectListParams> | undefined,
  options: OrvalHttpResourceOptions<PaginatedSuperContestEffectSummaryList, unknown> & {
    defaultValue: NoInfer<PaginatedSuperContestEffectSummaryList>;
  },
): HttpResourceRef<PaginatedSuperContestEffectSummaryList>;
export function superContestEffectListResource(
  params?: Signal<SuperContestEffectListParams>,
  options?: OrvalHttpResourceOptions<PaginatedSuperContestEffectSummaryList, unknown>,
): HttpResourceRef<PaginatedSuperContestEffectSummaryList | undefined>;
export function superContestEffectListResource(
  params?: Signal<SuperContestEffectListParams>,
  options?: OrvalHttpResourceOptions<PaginatedSuperContestEffectSummaryList, unknown>,
): HttpResourceRef<PaginatedSuperContestEffectSummaryList | undefined> {
  return httpResource<PaginatedSuperContestEffectSummaryList>(() => {
    const request = {
 ...
 * @experimental httpResource is experimental (Angular v19.2+)
 */
export function superContestEffectRetrieveResource(
  id: Signal<string>,
  options: OrvalHttpResourceOptions<SuperContestEffectDetail, unknown> & {
    defaultValue: NoInfer<SuperContestEffectDetail>;
  },
): HttpResourceRef<SuperContestEffectDetail>;
export function superContestEffectRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<SuperContestEffectDetail, unknown>,
): HttpResourceRef<SuperContestEffectDetail | undefined>;
export function superContestEffectRetrieveResource(
  id: Signal<string>,
  options?: OrvalHttpResourceOptions<SuperContestEffectDetail, unknown>,
): HttpResourceRef<SuperContestEffectDetail | undefined> {
  return httpResource<SuperContestEffectDetail>(
    () =>
...
export type ContestTypeListResourceResult = NonNullable<PaginatedContestTypeSummaryList>;
export type ContestTypeRetrieveResourceResult = NonNullable<ContestTypeDetail>;
export type ContestEffectListResourceResult = NonNullable<PaginatedContestEffectSummaryList>;
export type ContestEffectRetrieveResourceResult = NonNullable<ContestEffectDetail>;
export type SuperContestEffectListResourceResult =
  NonNullable<PaginatedSuperContestEffectSummaryList>;
export type SuperContestEffectRetrieveResourceResult = NonNullable<SuperContestEffectDetail>;
